...
function Hero() {
  return (
    <div className='flex flex-col items-center px-4 sm:px-8 md:px-16 lg:px-32 xl:px-56 gap-4 md:gap-6 lg:gap-9'>
      <h1 className='font-extrabold text-2xl sm:text-3xl md:text-4xl lg:text-[50px] text-center mt-6 md:mt-10'>
